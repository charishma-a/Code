...
import { ChampionAccountForm } from '@/components/Form/ChampionAccountForm'
import { useAuth } from '@/hooks/useAuth'
import { ChampionGlobalPageStyles } from '@/components/ChampionGlobalPageStyles'
import { MainContainer } from '@/common/styled'

const SecureChampionAccount: React.FC<BaseSecurePageProps> = ({
  ...
  return (
    <>
      ...
      <LayoutAuth
        ...
        me={me}
        showSidebar={false}
        title="Champion Account | Kernls"
        twitterImage=""
        url="https://kernls.com/secure/champion/account"
      >
        <MainContainer>
          <ChampionAccountForm me={me} style={{ maxWidth: '437px' }} />
        </MainContainer>
      </LayoutAuth>
    </>
  )
...
export default SecureChampionAccount
