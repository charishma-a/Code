...
const SecureChampionSettingsCampaign: React.FC<BaseSecurePageProps> = ({
  ...
  return (
    <>
      ...
      <LayoutAuth
        ...
        me={me}
        showSidebar
        title="Champion Payments Settings Campaign | Kernls"
        twitterImage=""
        url="https://kernls.com/secure/champion/settings/campaign"
      >
        <Tabs>
          <Link href={ROUTE_SECURE_CHAMPION_SETTINGS_CAMPAIGN} passHref>
            <LinkData isActive>Campaign</LinkData>
          </Link>
          <Link href={ROUTE_SECURE_CHAMPION_SETTINGS_PROFILE} passHref>
            <LinkData>Profile</LinkData>
          </Link>
        </Tabs>
        <MainContainer>
          <Content>
...
export default SecureChampionSettingsCampaign
