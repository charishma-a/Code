...
import { ContactsImportReview } from '@/components/ContactsImportReview'
  ...
  return (
    <>
      ...
      <LayoutAuth
        ...
        showSidebar={false}
        showHeader={false}
        title="Champion Create Contacts by File Review | Kernls"
        twitterImage=""
        url={`https://kernls.com/secure/champion/contacts/create-file/${id}/review`}
      >
        <ContactsImportReview fileId={id} />
      </LayoutAuth>
    </>
  )
}
